...
- Read to do - These texts would be shorter and less descriptive, allowing readers to go through instructions quickly with no scope for recalling. 

- Read to learn - These texts would follow a bookish, narrative style. They would have lengthier descriptions and conceptual references, allowing readers to learn in detail about a particular concept.

- Read to learn to do - These texts would follow a procedural style, allowing users to read and recall later. 
...
- Readers are information foragers - Still very much relevant. 
- Readers want information in isolated, portable chunks - Still relevant. 
- Readers access and interpret information through the lens of communities - There's more discussions on access right now than ever before. 
- Readers pull content rather than having it pushed on them - I think readers push and pull content at equal levels. 
- Readers use information to collaborate/cooperate with others - Readers still very much use information to collaborate with each other. 
