...
- Read to do: I expect direct and concise language and a procedural structure. Kind of depends on the exigence as well, i.e. how urgent the matter is. If it's instructions on how to operate an AED, I don't expect there to be any conceptual information, extraneous information, or flavorful language.
- Read to learn: This can vary much more stylistically, also depends on the author and subject matter, but I expect the use of figurative language, narratives, and more apparent uses of rhetorical tools.
- Read to learn to do: I expect kind of a combination of both here. There's direct and concise language but a presence of narrative and conceptual information.
